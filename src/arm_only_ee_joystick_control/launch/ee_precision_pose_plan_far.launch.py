    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                "max_goal_joint_delta": 0.25,

                "max_waypoint_joint_jump": 0.20,
                "max_total_joint_delta": 2.00,
                ...
                # 안전 기본값. 처음에는 절대 true로 바꾸지 말 것.
                "execute_plan": False,

                # execute하지 않아도 다음 좌표 테스트에서 직전 목표 자세를 continuity 기준으로 사용.
